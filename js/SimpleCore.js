...
var SimpleCore = {
    ...
    changeReadModel: function () {
        ...
        if (SimpleCore.getLocalData('read-mode') == 'night') {
            ...
            $(".cover-img").css({
                'background': "url('/haitao.github.io/images/cover-night.jpg')",
                'background-image': '/haitao.github.io/images/cover-night.jpg',
            ...
            $(".cover-img").css({
                'background': "url('/haitao.github.io/images/cover-day.jpg')",
                'background-image': '/haitao.github.io/images/cover-day.jpg',
                'background-size': 'cover',
                'background-position': 'center',
                'background-repeat': 'no-repeat'
            });
